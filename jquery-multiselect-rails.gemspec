...
Gem::Specification.new do |gem|
  ...
  gem.description   = ["This gem is a Rails engine and is configured to integrate with Rails asset pipeline"]
  gem.summary       = ["jQuery Multiselect wrapped as a Rails 3 gem"]
